...
public class RentalBikeScreen extends javax.swing.JFrame {
	@FXML
	private Label bikeCode, type, remainBattery, rentDuration, rentCost;

	@FXML
	private Button OK, lock, unlock;
	...
	public void setRentalBikeInfo(String rentalCode) {
		...
		int rentBikeCost = bike.calculateDeposit();
		...
		if (bikeType.equals("Xe đạp điện")) {
		...
		rentDuration.setText(CardInfoScreen.dhbg.show());
	}
	...
	public void lockClick() {
		CardInfoScreen.dhbg.Stop();
		NotificationBox.display("NotificationBox", "Your bike is locked");
	}
	
	@FXML
	public void unlockClick() {
		CardInfoScreen.dhbg.Start();
		NotificationBox.display("NotificationBox", "Your bike is unlocked");
	}
